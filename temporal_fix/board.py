...
class EnviroBoard():
    ...
    def __init__(self):
        ...
        self._bmp280 = BMP280(port=1, mode=BMP280.FORCED_MODE, oversampling_p=BMP280.OVERSAMPLING_P_x16, oversampling_t=BMP280.OVERSAMPLING_T_x1,
    ...
    def temperature(self):
        ...
        temperature = self._hdc2010.readTemperature()
    ...
    def pressure(self):
        ...
        """
        return self._bmp280.read_pressure()
